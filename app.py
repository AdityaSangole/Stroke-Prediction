...
if page == "Home":
    ...
    avg_glucose_level = st.number_input("Please enter your average glucose level (mg/dL)", min_value=0.0)  # No default value
    bmi = st.number_input("Please enter your BMI", min_value=0.0)  # No default value
...
# Working of Model Page
    ...
    st.write("""
        ...
        """.format(
            train_score=metrics['train_score'][0],
            test_score=metrics['test_score'][0],
            precision_score=metrics['precision_score'][0],
            recall_score=metrics['recall_score'][0],
